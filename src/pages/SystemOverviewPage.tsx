...
export function SystemOverviewPage() {
  ...
  return (
    <>
      ...
      <section className="panel-block"><SectionHeading kicker="PHYSICAL FLOW" title="Alur energi dan distribusi air" description="PLN tidak digantikan; jaringan menjadi cadangan ketika produksi surya atau persediaan air tidak memenuhi kebutuhan." /><SystemFlow data={data} /><div className="engineering-note"><DropletNote /></div></section>
